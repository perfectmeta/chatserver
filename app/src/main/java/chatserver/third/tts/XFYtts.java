...
import chatserver.third.tts.entity.LTTSResponse;
...
public class XFYtts {
    ...
    private static String createLTTSTask(String content) {
        ...
        try (Response response = client.newCall(request).execute()){
            ...
            ObjectMapper mapper = new ObjectMapper();
            var res = mapper.readValue(body, chatserver.third.tts.entity.create.res.Response.class);
    ...
    private static byte[] waitForLTTSTask(String taskId) {
        ...
        do {
            ...
            try (var response = client.newCall(request).execute()){
                ...
                var content = om.readValue(body, chatserver.third.tts.entity.query.res.Response.class);
